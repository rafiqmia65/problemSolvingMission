...
console.log(calculateAverage([12, 34, 56, 78, 90])); // Output: 54
console.log(calculateAverage([3, 6, 9, 12, 15, 18])); // Output: 10.5
console.log(calculateAverage([])); // Output: "Invalid"
