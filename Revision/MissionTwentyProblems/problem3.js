...
console.log(removeWords("Dev Zero One")); // Output: " Zero One"
console.log(removeWords("I love programming")); // Output: "ove programming"
console.log(removeWords("Hello World")); // Output: "lo World"
console.log(removeWords("JS Rocks!")); // Output: "Rocks!"
console.log(removeWords("Yes")); // Output: "String is too short to remove"
console.log(removeWords("")); // Output: "Input is Invalid"
